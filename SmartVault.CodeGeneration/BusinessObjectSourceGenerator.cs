...
namespace SmartVault.CodeGeneration
{
    ...
    public class BusinessObjectSourceGenerator : ISourceGenerator
    {
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            // refactor to use .Length so any additional files are processed
            for (int i = 0; i < context.AdditionalFiles.Length; i++)
            {
                ...
                //assuring that every object have the createdOn property
...
{{
    ...
    {{
{propertiesString}
        public System.DateTime CreatedOn = System.DateTime.UtcNow;
    }}
}}
";
